...
async def time_based_caveats_example_async(
    console,
    service_key,
    admin_key,
    did_key_store,
    ...
    target = {
        "id": "https://example.com/api/resource/time_locked",
        "type": "ApiResource",
    }
    ...
    try:
        await verify_capability(
            cap_valid_until, did_key_store, revoked_caps, capability_store
        )
        console.print(
            "[green]✓[/green] Verification: [bold green]Valid[/bold green] (as expected)"
        )
    ...
    try:
        ...
        console.print(
            "[red]![/red] Verification: [bold green]Valid[/bold green] (UNEXPECTED, should be expired)"
        )
    except CapabilityVerificationError as e:
    ...
    try:
        ...
        console.print(
            "[red]![/red] Invocation successful (UNEXPECTED, should be expired)"
        )
    ...
    try:
        await verify_capability(
            cap_valid_after, did_key_store, revoked_caps, capability_store
        )
        console.print(
            "[red]![/red] Verification: [bold green]Valid[/bold green] (UNEXPECTED, not active yet)"
        )
    except CapabilityVerificationError as e:
        console.print(f"[green]✓[/green] Verification failed as expected: {e}")
...
async def action_restriction_caveats_example_async(
    console,
    service_key,
    admin_key,
    user_key,
    ...
    try:
        delegated_cap = await delegate_capability(
            ...
            new_invoker_did="did:example:user",
            caveats=[{"type": "AllowedAction", "actions": ["read"]}],
            did_key_store=did_key_store,
            revoked_capabilities=revoked_caps,
            capability_store=capability_store,
        )
        capability_store[delegated_cap.id] = delegated_cap
        console.print(
            f"[green]✓[/green] Delegated capability {delegated_cap.id} created."
        )
    except ZCAPException as e:
    ...
    try:
        ...
        console.print(
            "[green]✓[/green] 'read' invocation: [bold green]Successful[/bold green]"
        )
    except InvocationError as e:
    ...
    try:
        ...
        console.print(
            "[red]![/red] 'write' invocation: [bold green]Successful[/bold green] (UNEXPECTED)"
        )
    except InvocationError as e:
...
async def parameter_restriction_example_async(
    console,
    service_key,
    admin_key,
    user_key,
    ...
    try:
        ...
        capability_store[root_cap.id] = root_cap
        console.print(
            f"[green]✓[/green] Root capability {root_cap.id} created for 'update' action."
        )
    except ZCAPException as e:
        console.print(f"[red]✗[/red] Creation failed: {e}")
        return
    ...
    try:
        delegated_cap = await delegate_capability(
            ...
            new_invoker_did="did:example:user",
            caveats=[
                {"type": "RequireParameter", "parameter": "itemId", "value": "item-42"}
            ],
            did_key_store=did_key_store,
            revoked_capabilities=revoked_caps,
            capability_store=capability_store,
    ...
    try:
        await invoke_capability(
            ...
            nonces,
            nonce_ts,
            parameters={"itemId": "item-42", "data": "new_value"},
        )
        console.print(
            "[green]✓[/green] Invocation with correct param: [bold green]Successful[/bold green]"
        )
    except InvocationError as e:
    ...
    try:
        await invoke_capability(
            ...
            nonces,
            nonce_ts,
            parameters={"itemId": "item-99", "data": "other_value"},
        )
        console.print(
            "[red]![/red] Invocation with incorrect param value: [bold green]Successful[/bold green] (UNEXPECTED)"
        )
    except InvocationError as e:
        console.print(
            f"[green]✓[/green] Invocation with incorrect param value failed as expected: {e}"
        )
    ...
    try:
        ...
        console.print(
            "[red]![/red] Invocation with missing param: [bold green]Successful[/bold green] (UNEXPECTED)"
        )
    except InvocationError as e:
        console.print(
            f"[green]✓[/green] Invocation with missing param failed as expected: {e}"
        )
    console.print("--- Parameter Restriction Caveats Example Complete ---\n")


async def conditional_caveat_example_async(
    console,
    service_key,
    admin_key,
    user_key,
    ...
    console.print(
        Panel.fit(
            "[bold cyan]Conditional Caveat (ValidWhileTrue) Example[/bold cyan]",
            border_style="cyan",
            padding=(1, 2),
        )
    )
    target = {
        "id": "https://example.com/features/beta_feature",
    ...
    try:
        cap_conditional = await create_capability(
            ...
            controller_key=service_key,
            caveats=[
                {"type": "ValidWhileTrue", "conditionId": condition_id_for_caveat}
            ],
        )
        capability_store[cap_conditional.id] = cap_conditional
        console.print(
            f"[green]✓[/green] Conditional capability {cap_conditional.id} created."
        )
    except ZCAPException as e:
        console.print(f"[red]✗[/red] Creation failed: {e}")
        return
    ...
    try:
        await verify_capability(
            cap_conditional, did_key_store, revoked_caps, capability_store
        )
        console.print(
            "[green]✓[/green] Verification (condition TRUE): [bold green]Valid[/bold green]"
        )
        await invoke_capability(
            cap_conditional,
            "access",
        ...
        console.print(
            "[green]✓[/green] Invocation (condition TRUE): [bold green]Successful[/bold green]"
        )
    except (CapabilityVerificationError, InvocationError) as e:
        console.print(
            f"[red]✗[/red] Verification/Invocation failed (condition TRUE): {e}"
        )
    ...
    console.print(
        f"[yellow]![/yellow] '{condition_id_for_caveat}' added to 'revoked_caps' set."
    )
    ...
    try:
        ...
        console.print(
            "[red]![/red] Verification (condition FALSE): [bold green]Valid[/bold green] (UNEXPECTED)"
        )
    except CapabilityVerificationError as e:
        console.print(
            f"[green]✓[/green] Verification (condition FALSE) failed as expected: {e}"
        )
    ...
    try:
        ...
        console.print(
            "[red]![/red] Invocation (condition FALSE): [bold green]Successful[/bold green] (UNEXPECTED)"
        )
    except (InvocationError, CapabilityVerificationError) as e:
        console.print(
            f"[green]✓[/green] Invocation (condition FALSE) failed as expected: {e}"
        )
    console.print("--- Conditional Caveat Example Complete ---\n")


async def delegation_chain_caveats_example_async(
    console,
    service_key,
    admin_key,
    user_key,
    ...
    target = {
        "id": "https://example.com/project/files/confidential.doc",
        "type": "ProjectFile",
    }
    root_cap = None
    console.print(
    ...
    try:
        root_cap = await create_capability(
            controller_did="did:example:service",
            invoker_did="did:example:admin",
            actions=[{"name": "read"}, {"name": "comment"}],
            target_info=target,
            controller_key=service_key,
            expires=root_expiry,
    ...
    try:
        ...
        console.print(
            f"[green]✓[/green] User delegated capability {user_delegated_cap.id} created."
        )
    except ZCAPException as e:
    ...
    try:
        guest_delegated_cap = await delegate_capability(
            parent_capability=user_delegated_cap,
        ...
        console.print(
            f"[green]✓[/green] Guest delegated capability {guest_delegated_cap.id} created."
        )
    except ZCAPException as e:
    ...
    try:
        await verify_capability(
            guest_delegated_cap, did_key_store, revoked_caps, capability_store
        )
        console.print(
            "[green]✓[/green] Guest capability verification: [bold green]Valid[/bold green] (assuming current time is within 08:00-18:00 and on corp_vpn)"
        )
    except CapabilityVerificationError as e:
    ...
    try:
        ...
        console.print(
            "[green]✓[/green] Guest invocation: [bold green]Successful[/bold green] (caveats met)"
        )
    except InvocationError as e:
    ...
    console.print(
        f"[yellow]![/yellow] Root capability {root_cap.id} added to revoked set."
    )
    ...
    try:
        ...
        console.print(
            "[red]![/red] Guest invocation after parent revoke: [bold green]Successful[/bold green] (UNEXPECTED)"
        )
    except (InvocationError, CapabilityVerificationError) as e:
        console.print(
            f"[green]✓[/green] Guest invocation after parent revoke failed as expected: {e}"
        )
    console.print("--- Delegation Chain Caveats Example Complete ---\n")


async def unknown_and_unevaluatable_caveats_example_async(
    console,
    service_key,
    admin_key,
    did_key_store,
    ...
    console.print(
        Panel.fit(
            "[bold cyan]Unknown & Client-Side Caveats Example[/bold cyan]",
            border_style="cyan",
            padding=(1, 2),
        )
    )
    ...
    try:
        ...
        console.print(
            f"[green]✓[/green] Capability {cap_with_unknown.id} created with unknown/client-side caveats."
        )
    except ZCAPException as e:
        console.print(f"[red]✗[/red] Creation failed: {e}")
        return
    ...
    try:
        await verify_capability(
            cap_with_unknown, did_key_store, revoked_caps, capability_store
        )
        console.print(
            "[red]![/red] Verification with unknown caveat: [bold green]Valid[/bold green] (UNEXPECTED - unknown caveats should cause failure)"
        )
    except CapabilityVerificationError as e:
        console.print(
            f"[green]✓[/green] Verification with unknown caveat failed as expected: {e}"
        )
    ...
    try:
        ...
        console.print(
            "[red]![/red] Invocation with unknown caveat: [bold green]Successful[/bold green] (UNEXPECTED)"
        )
    except (InvocationError, CapabilityVerificationError) as e:
        console.print(
            f"[green]✓[/green] Invocation with unknown caveat failed as expected: {e}"
        )
    ...
    console.print(
        "as they require client-side context (e.g., request IP). The client application is responsible"
    )
    console.print(
        "for evaluating such caveats before or after library calls if they are critical."
    )
...
def print_test_result(test_name, success, details=""):
    ...
    color_status = (
        "\033[92m" + status + "\033[0m" if success else "\033[91m" + status + "\033[0m"
    )
...
async def run_caveat_evaluation_tests():
    ...
    try:
        ...
        print_test_result(
            "ValidUntil - Expired",
            False,
            "Exception not raised as expected for expired caveat.",
        )
    except CaveatEvaluationError:
        print_test_result(
            "ValidUntil - Expired", True, "Correctly failed for expired caveat."
        )
    ...
    try:
        ...
        print_test_result(
            "ValidAfter - Not Yet Active", False, "Exception not raised as expected."
        )
    except CaveatEvaluationError:
        print_test_result(
            "ValidAfter - Not Yet Active", True, "Correctly failed as not yet active."
        )
    ...
    try:
        evaluate_caveat(
            {"type": "ValidWhileTrue", "conditionId": "condition:active"},
            revoked_ids=revoked_ids_for_vwt,
        )
    ...
    try:
        evaluate_caveat(
            {"type": "ValidWhileTrue", "conditionId": "condition:revoked"},
            revoked_ids=revoked_ids_for_vwt,
        )
        print_test_result(
            "ValidWhileTrue - Revoked", False, "Exception not raised as expected."
        )
    except CaveatEvaluationError:
        print_test_result(
            "ValidWhileTrue - Revoked",
            True,
            "Correctly failed as condition is revoked.",
        )

    # AllowedAction
    try:
        evaluate_caveat(
            {"type": "AllowedAction", "actions": ["read", "update"]}, action="read"
        )
    ...
    try:
        ...
        print_test_result(
            "AllowedAction - Denied", False, "Exception not raised as expected."
        )
    except CaveatEvaluationError:
        print_test_result(
            "AllowedAction - Denied", True, "Correctly failed as action not allowed."
        )
    try:  # No action context, should pass
        evaluate_caveat({"type": "AllowedAction", "actions": ["read"]})
        print_test_result(
            "AllowedAction - No action context",
            True,
            "Caveat did not restrict as no action was being taken.",
        )
    except CaveatEvaluationError as e:
        print_test_result(
            "AllowedAction - No action context", False, f"Unexpected failure: {e}"
        )

    # RequireParameter
    try:
        evaluate_caveat(
            {"type": "RequireParameter", "parameter": "format", "value": "json"},
            action="export",
    ...
    try:
        ...
        print_test_result(
            "RequireParameter - Wrong Value", False, "Exception not raised."
        )
    except CaveatEvaluationError:
    ...
    try:
        ...
        print_test_result(
            "RequireParameter - Missing Param", False, "Exception not raised."
        )
    except CaveatEvaluationError:
    ...
    try:  # No parameter context for action
        ...
        print_test_result(
            "RequireParameter - No parameter context", False, "Exception not raised."
        )
    except CaveatEvaluationError:
        print_test_result(
            "RequireParameter - No parameter context", True, "Correctly failed."
        )
    ...
    try:
        ...
        print_test_result(
            "Unknown Caveat Type", False, "Exception not raised for unknown type."
        )
    except CaveatEvaluationError:
        print_test_result(
            "Unknown Caveat Type", True, "Correctly failed for unknown type."
        )
...
async def run_caveats_in_capabilities_tests(
    ...
    try:
        cap_valid_until_active = await create_capability(
            ...
            actions=[{"name": "read"}],
            target_info={
                "id": "urn:resource:valid_until_active",
                "type": "TestResource",
            },
    ...
    try:
        cap_valid_until_expired = await create_capability(
            ...
            actions=[{"name": "read"}],
            target_info={
                "id": "urn:resource:valid_until_expired",
                "type": "TestResource",
            },
            controller_key=service_key,  # Use passed-in private key
        ...
        await verify_capability(
            cap_valid_until_expired,
            did_key_store,
            revoked_capabilities,
            capability_store,
        )
        print_test_result(
            "Cap with ValidUntil (Expired) - Verification",
            False,
    ...
    try:
        cap_allowed_action = await create_capability(
            ...
            target_info={
                "id": "urn:resource:allowed_action_test",
                "type": "TestResource",
            },
            controller_key=service_key,  # Use passed-in private key
            caveats=[{"type": "AllowedAction", "actions": ["read"]}],
    ...
    if cap_allowed_action:
        try:
            ...
            print_test_result(
                "AllowedAction - Invoke Denied Action",
                False,
                "Invocation should fail due to caveat.",
            )
        except InvocationError as e:
            if "Caveat not satisfied" in str(
                e
            ) or "Invocation failed due to caveat" in str(e):
                print_test_result(
                    "AllowedAction - Invoke Denied Action",
                    True,
                    "Correctly failed due to caveat.",
                )
            else:
                print_test_result(
                    "AllowedAction - Invoke Denied Action",
                    False,
                    f"Failed, but not due to expected caveat error: {e}",
                )
        except ZCAPException as e:
            print_test_result(
                "AllowedAction - Invoke Denied Action",
    ...
    try:
        parent_cap_for_delegation = await create_capability(
            ...
            target_info={
                "id": "urn:resource:delegation_caveat_test",
                "type": "TestResource",
            },
            controller_key=service_key,  # Use passed-in private key
            caveats=[
    ...
    if delegated_cap_with_caveats:
        try:
            ...
            print_test_result(
                "Delegated Caveats - Invoke Success (Params Met)", False, e
            )
        ...
        try:
            ...
            print_test_result(
                "Delegated Caveats - Invoke Fail (Param Mismatch)",
                False,
            ...
            if "Caveat not satisfied" in str(
                ...
                print_test_result(
                    "Delegated Caveats - Invoke Fail (Param Mismatch)",
                    True,
                    "Correctly failed due to RequireParameter caveat.",
                )
            else:
                print_test_result(
                    "Delegated Caveats - Invoke Fail (Param Mismatch)",
                    False,
                    f"Failed, but not for expected caveat reason: {e}",
                )
        except ZCAPException as e:
            print_test_result(
                "Delegated Caveats - Invoke Fail (Param Mismatch)",
        ...
        if parent_cap_for_delegation:
            ...
            parent_cap_for_delegation.caveats = [
                {
                    "type": "ValidUntil",
                    "date": (datetime.utcnow() - timedelta(days=1)).isoformat(),
                }
            ...
            try:
                ...
                print_test_result(
                    "Delegated Caveats - Parent Expired (Verification)",
                    False,
                    "Verification should fail due to expired parent caveat.",
                )
            except CapabilityVerificationError as e:
                if "Caveat evaluation failed" in str(e):
                    print_test_result(
                        "Delegated Caveats - Parent Expired (Verification)",
                        True,
                        "Correctly failed due to expired parent caveat.",
                    )
                else:
                    print_test_result(
                        "Delegated Caveats - Parent Expired (Verification)",
                        False,
                        f"Verification failed, but not for expected parent caveat reason: {e}",
                    )
            except ZCAPException as e:
                print_test_result(
                    "Delegated Caveats - Parent Expired (Verification)",
...
async def main():
    ...
    await time_based_caveats_example_async(
        console,
        service_key_priv,
        admin_key_priv,
        did_key_store,
    ...
    await action_restriction_caveats_example_async(
        console,
        service_key_priv,
        admin_key_priv,
        user_key_priv,
    ...
    await parameter_restriction_example_async(
        console,
        service_key_priv,
        admin_key_priv,
        user_key_priv,
    ...
    await conditional_caveat_example_async(
        console,
        service_key_priv,
        admin_key_priv,
        user_key_priv,
    ...
    await delegation_chain_caveats_example_async(
        console,
        service_key_priv,
        admin_key_priv,
        user_key_priv,
    ...
    await unknown_and_unevaluatable_caveats_example_async(
        console,
        service_key_priv,
        admin_key_priv,
        did_key_store,
    ...
    used_invocation_nonces.clear()
    nonce_timestamps.clear()
    await run_caveats_in_capabilities_tests(
        service_key_priv,
        admin_key_priv,
        user_key_priv,
        guest_key_priv,
